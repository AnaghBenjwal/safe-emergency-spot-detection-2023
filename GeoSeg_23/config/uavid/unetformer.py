...
train_dataset = UAVIDDataset(data_root=r"uavid_v1.5_official_release_image_bw\uavid_patch_train", img_dir='Images', mask_dir='Masks',
                             mode='train', mosaic_ratio=0.25, transform=train_aug, img_size=(1024, 1024))

val_dataset = UAVIDDataset(data_root=r"uavid_v1.5_official_release_image_bw\uavid_patch_val", img_dir='Images', mask_dir='Masks', mode='labels',
